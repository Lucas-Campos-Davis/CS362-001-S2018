	...
	//			System.out.println(" Seed:"+randomseed );
			...
			for (int i = 0; i < NUM_TESTS; i++) {
				...
				if (methodName.equals("setValid")){
                    ...
                    Appt appt1 = new Appt(startHourT,
                            startMinuteT ,
                            startDayT ,
                            startMonthT ,
                            startYearT ,
                    ...
                    int startDayT=ValuesGenerator.getRandomIntBetween(random, 1, 11);
                    int startMonthT=ValuesGenerator.getRandomIntBetween(random, 1, 11);
                    int startYearT=ValuesGenerator.getRandomIntBetween(random, 2017, 2018);
				    appt.isOn(startDayT,startMonthT,startYearT);
                }
			}
